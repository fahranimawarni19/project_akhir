            ...
            <div class="card-body">
                <!-- SOURCE CODE GRAFIK DATA TIMBANGAN SAMPAH DARI NASABAH BLM -->
                    <?php
                      ...
                      // Query untuk mengambil data jenis sampah dan total berat sampah per kode sampah
                      $sql =mysqli_query($con, "SELECT tb_sampah.jenis_sampah, SUM(tb_detail_timbangan.berat) as total_berat 
                      FROM tb_detail_timbangan JOIN tb_sampah ON tb_detail_timbangan.kode_sampah = tb_sampah.kode_sampah
                          ...
                          <div class="card-body">
                            <figure class="highcharts-figure">
                              ...
                              <p class="highcharts-description">
                                  ...
                                  Grafik ini menunjukkan distribusi total berat sampah berdasarkan jenis sampah dalam tata letak pie 3D. Klik pada potongan untuk memilih dan membatalkan pemilihan. Perhatikan bahwa pie 3D, meskipun dekoratif, dapat sulit dibaca, dan sudut pandang dapat membuat potongan yang dekat dengan pengguna tampak lebih besar dari yang sebenarnya.
                              </p>
                            </figure>
                          </div>
                        </div>
