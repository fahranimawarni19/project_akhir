            ...
            <div class="container-fluid mt-5 d-flex justify-content-center w-100">
                <div class="col-12">
                   <table class="table dt-responsive nowrap w-100 table-hover table-striped">
                        ...
                        <tr>
                            <th colspan="4" class="text-right">Jumlah Penarikan </th>
                            <th class="text-right mb-5"><?= rupiah($total_penarikan) ?></th>
                        </tr>
                        <tr>
                            <th colspan="4" class="text-right">Sisa Saldo </th>
                            <th class="text-right mb-5"><?= rupiah($sisa_saldo) ?></th>
                        </tr>
                        <tr>
                            ...
                            <td class="text-right mb-5">
                                <div class="container-fluid w-100">
                                    <a href="admin.php?page=Struk&id_nasabah=<?=$r['id_nasabah']?>" class="btn btn-primary float-right mt-4 ml-2"><i class="mdi mdi-printer mr-1"></i> Print</a>
