...
<head>
    ...
    <meta charset="utf-8" />
    <title>Registrasi | Pengurus Bank Sampah BLM Mekar Laha</title>
            ...
            <div class="col-10 col-md-6 col-lg-4 col-xxl-3">
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="p-2 mt-5">
                            <form class="" action="https://codebucks.in/clivax/layout/index.html">
                                <div class="input-group auth-form-group-custom mb-3">
                                    ...
                                    <input type="email" class="form-control" id="useremail" placeholder="Enter email" aria-label="email" aria-describedby="basic-addon3">
                                </div>
                                ...
                                <div class="input-group auth-form-group-custom mb-3">
                                    ...
                                    <input type="password" class="form-control" id="userpassword" placeholder="Enter password" aria-label="Password" aria-describedby="basic-addon2">
                                </div>

                                <div class="text-center pt-3">
                                    <button class="btn btn-primary w-xl waves-effect waves-light" type="submit">Registrasi</button>
                                </div>
                            </form>
                        </div>
